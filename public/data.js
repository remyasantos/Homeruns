...
const SLATE_DATE  = "APRIL 26, 2026";
const SLATE_LABEL = "SUNDAY MLB SLATE";

const CONTEXT_CARDS = [
  { icon: "💣", label: "Camden Yards — BOS@BAL",        note: "Woods Richardson DISASTER — 12 R in Last 2 Starts",   sub: "Simeon Woods Richardson has allowed 12 runs in his last two starts and is the biggest SP disaster arm on Sunday's board. Henderson, Mullins, and Mountcastle all get Camden Yards' favorable LF wind in what is the cleanest HR context of the day." },
  { icon: "📈", label: "Rate Field — WSH@CWS",          note: "Irvin 6.16 ERA / xERA 5.09 — CWS Regression Bomb",    sub: "Jake Irvin carries a 6.16 ERA and a 5.09 xERA — the confirmed regression arm on Sunday's slate for the second straight day. Munetaka Murakami (MLB HR leader) and Colson Montgomery are the top CWS bats targeting Irvin's documented command collapse." },
  { icon: "🔥", label: "Great American Ball Park — DET@CIN", note: "Lowder Weak / #1 HR Park — CIN Bats Prime",      sub: "GABP is the #1 HR park in baseball and Rhett Lowder is a hittable young arm — Elly De La Cruz and Tyler Stephenson get ideal warm conditions at the most HR-friendly environment on Sunday's board." },
  { icon: "💨", label: "Dodger Stadium — CHC@LAD",      note: "Ohtani vs Rea — LAD Power Active",                    sub: "Colin Rea is a solid but hittable arm at 3.00 ERA, and Shohei Ohtani's model-leading HR probability makes him a legitimate S-tier anchor even against a quality pitcher at Dodger Stadium with favorable CF wind." },
];

const PARK_FACTORS = {
  "Camden Yards":                   { rank: 1,  label: "💣 #1 — Woods Richardson DISASTER, Wind Out LF",  color: "#ff6b35" },
  "Great American Ball Park":       { rank: 2,  label: "🔥 #2 — Warm, Lowder Hittable Young Arm",         color: "#ffb347" },
  "UNIQLO Field at Dodger Stadium": { rank: 3,  label: "💨 #3 — Wind Out CF, Rea 3.00 ERA Solid",         color: "#ffb347" },
  "Dodger Stadium":                 { rank: 3,  label: "💨 #3 — Wind Out CF, Rea 3.00 ERA Solid",         color: "#ffb347" },
  "Guaranteed Rate Field":          { rank: 4,  label: "📈 #4 — Irvin 6.16 ERA / xERA 5.09 Disaster",     color: "#ffb347" },
  "Rate Field":                     { rank: 4,  label: "📈 #4 — Irvin 6.16 ERA / xERA 5.09 Disaster",     color: "#ffb347" },
  "Truist Park":                    { rank: 5,  label: "🌤️ #5 — Warm, Nola Solid vs ATL Power",           color: "#b0bec5" },
  "Daikin Park":                    { rank: 6,  label: "💣 #6 — Dome, Gil 4.11 ERA vs HOU Bats",          color: "#b0bec5" },
  "Rogers Centre":                  { rank: 7,  label: "🏟️ Dome — Cantillo Weak, TOR Bats Prime",         color: "#90e0ef" },
  "Kauffman Stadium":               { rank: 8,  label: "🌤️ #8 — Kochanowicz Young Arm, KC Window",       color: "#b0bec5" },
  "Tropicana Field":                { rank: 9,  label: "🏟️ Dome — Scholtens Mediocre, MIN Bats OK",      color: "#b0bec5" },
  "Globe Life Field":               { rank: 10, label: "🏟️ Dome — Rocker Command Issues 4.3 BB/9",       color: "#b0bec5" },
  "Oracle Park":                    { rank: 11, label: "🌤️ — Mahle Mediocre, SF Wind Moderate",          color: "#b0bec5" },
  "American Family Field":          { rank: 12, label: "🏟️ Dome — Mlodzinski HOT 0 ER in 11.1 IP",      color: "#78909c" },
  "Busch Stadium":                  { rank: 13, label: "🌬️ Wind In — McGreevy Mediocre, Suppressed",     color: "#78909c" },
};
...
const players = [
  {
    ...
    "pitcherNote": "2-0, 2.45 ERA — elite young arm, bad HR matchup for NYY",
    "matchupGrade": "C",
    "estOdds": "+240",
  ...
  },
  {
    ...
    "park": "Dodger Stadium",
    "pitcher": "Colin Rea",
    "pitcherNote": "3.00 ERA, 3-0 — solid Cubs arm, Dodger bats still elite HR threats",
    "matchupGrade": "B+",
    "estOdds": "+186",
  ...
  },
  {
    ...
    "pitcher": "Jake Irvin",
    "pitcherNote": "6.16 ERA, xERA 5.09 — confirmed regression disaster, CWS bats prime",
    "matchupGrade": "A+",
    "estOdds": "+290",
  ...
  },
  {
    ...
    "park": "Truist Park",
    "pitcher": "Aaron Nola",
    "pitcherNote": "1-2, xFIP 3.66 — solid but hittable, ATL power has window",
    "matchupGrade": "B",
    "estOdds": "+330",
  ...
  },
  {
    ...
    "pitcherNote": "2.45 ERA, xERA 2.55 — elite Dodger ace, CHC bats are severe longshots",
    "matchupGrade": "C",
    "estOdds": "+390",
  ...
  },
  {
    ...
    "park": "Daikin Park",
    "pitcher": "Luis Gil",
    "pitcherNote": "1-1, 4.11 ERA — command issues, moderate HR window",
    "matchupGrade": "B",
    "estOdds": "+280",
  ...
  },
  {
    ...
    "pitcherNote": "young CIN arm — hittable, weak command, CIN bats at home prime",
    "matchupGrade": "A",
    "estOdds": "+420",
  ...
  },
  {
    ...
    "pitcherNote": "12 R allowed in last 2 starts — confirmed disaster arm, BAL bats prime at Camden",
    "matchupGrade": "A+",
    "estOdds": "+300",
  ...
  },
  {
    ...
    "pitcherNote": "LAA young arm — moderate, KC bats have window",
    "matchupGrade": "B+",
    "estOdds": "+330",
  ...
  },
  {
    ...
    "park": "Kauffman Stadium",
    "pitcher": "Seth Lugo",
    "pitcherNote": "1.48 ERA, 0.99 WHIP — elite 2026 start, LAA bats are severe longshots",
    "matchupGrade": "C",
    "estOdds": "+420",
  ...
  },
  {
    ...
    "park": "Rogers Centre",
    "pitcher": "Dylan Cease",
    "pitcherNote": "elite TOR ace — dominant K stuff, CLE bats are longshots",
    "matchupGrade": "C",
    "estOdds": "+350",
  ...
  },
  {
    ...
    "park": "Truist Park",
    "pitcher": "Chris Sale",
    "pitcherNote": "4-1, xFIP 3.12 — elite veteran, PHI bats face tough LHP",
    "matchupGrade": "C",
    "estOdds": "+350",
  ...
  },
  {
    ...
    "tier": "A",
    "park": "Oracle Park",
    "pitcher": "TBD (MIA Starter)",
    "pitcherNote": "MIA starter TBD — moderate, Oracle Park wind moderate",
    "matchupGrade": "B",
    "estOdds": "+620",
  ...
  },
  {
    ...
    "pitcherNote": "4.3 BB/9 command issues — walks set up HR opportunities for TEX",
    "matchupGrade": "B+",
    "estOdds": "+400",
  ...
  },
  {
    ...
    "park": "Globe Life Field",
    "pitcher": "J.T. Ginn",
    "pitcherNote": "ATH starter — moderate arm, moderate matchup",
    "matchupGrade": "B",
    "estOdds": "+450",
  ...
  },
  {
    ...
    "pitcherNote": "mediocre TB arm — MIN bats have moderate HR window in dome",
    "matchupGrade": "B+",
    "estOdds": "+480",
  ...
  },
  {
    ...
    "pitcher": "TBD (MIL Starter)",
    "pitcherNote": "MIL starter TBD — moderate matchup",
    "matchupGrade": "B",
    "estOdds": "+800",
  ...
  },
  {
    ...
    "park": "Oracle Park",
    "pitcher": "Tyler Mahle",
    "pitcherNote": "SF starter — mediocre, MIA bats have moderate window",
    "matchupGrade": "B",
    "estOdds": "+950",
